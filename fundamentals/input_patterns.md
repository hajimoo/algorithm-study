...
> **EN Summary:** Common input handling patterns in Python for coding interviews, including fast I/O with `sys.stdin.readline`.
...
## 6️⃣ 2D Grid Map Input (Very Common in BOJ)
